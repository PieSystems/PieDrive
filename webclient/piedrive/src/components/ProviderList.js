...
export default class ProviderList extends Component {
  ...
  render() {
    return(
      <List sortable>
      <ListGroup>
        <ListItem title='Dropbox' onClick={this.onDropbox} link="/" media='<i class="fa fa-2x fa-dropbox" aria-hidden="true"></i>'></ListItem>
        <ListItem title="Google Drive" link="#" media='<i class="fa fa-2x fa-google" aria-hidden="true"></i>'></ListItem>
      </ListGroup>
      </List>
    );
  }
